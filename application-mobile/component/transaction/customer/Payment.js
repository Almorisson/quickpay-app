...
import { View, Text, Button, Linking, WebView } from 'react-native';
...
class Payment extends React.Component {
    ...
    paypal() {
        axios.post('https://quickpay-api.herokuapp.com/api/v1/payments/payment/', { amount: this.props.navigation.getParam('amount') })
            .then(response => {
