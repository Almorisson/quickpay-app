...
class Profile extends React.Component {
    ...
    profile = (token) => {
        ...
        axios.get('http://10.0.2.2:3000/api/v1/traders/' + this.state.id, {
            headers:
            ...
            AsyncStorage.multiGet(keys, (err, stores) => {
                stores.map((result, i, store) => {
                    ...
                    if (key == 'email' && this.props.email[0] != null) {
                        console.log("PROPS EMAIL : ", this.props.email[this.props.email.length - 1])
                        ...
                        async () => {
                            try {
                                await AsyncStorage.setItem('firstname', this.props.firstName[this.props.firstName.length - 1], () => {
                        ...
                        //console.log("PROPS FIRSTNAME : ", this.props.firstName[this.props.firstName.length - 1])
                        ...
                        console.log("PROPS LASTNAME : ", this.props.lastName[this.props.lastName.length - 1])
